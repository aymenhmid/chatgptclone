this repo is a simple chatgpt clone using streamlit, the model will be fine tuned later for specific tasks using RAG.For the time being these are the steps to use this repo:
